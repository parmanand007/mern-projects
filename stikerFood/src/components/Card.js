...
useEffect(()=>{
  ...
  return (
        ...
        >
          <img src={props.foodItem.img} style={{objectFit:"fill",height:"150px"}} className="card-img-top object-fit-fill border rounded" alt="..." />
          <div className="card-body">
            <h5 className="card-title">{props.foodItem.name}</h5>
            <div className="container w-100">
              <select className="m-2  rounded" onChange = {(e)=>setQty(e.target.value)}>
